...
import { calculateOrderFinancials, formatCurrency } from '../utils/taxUtils';
...
export const OrdersPage: React.FC = () => {
  ...
  return (
    <>
              ...
              <div className="flex items-center justify-between gap-4 border-b border-gray-100 dark:border-slate-800 pb-3">
                ...
                <div className="text-right">
                  <span className="text-base font-black text-gray-900 dark:text-white">
                    {formatCurrency(calculateOrderFinancials(order).grandTotal)}
                  </span>
                  <p className="text-[11px] text-gray-400 dark:text-slate-400">{order.payment_method || 'Online Payment'}</p>
                </div>
              </div>
      ...
      {/* Customer Referral Banner */}
      <CustomerReferralBanner className="mt-6" />

      {/* Support Help Banner */}
      <CustomerOrderHelpCard className="mt-6" />
